...
export default function HeroText() {
  return (
    <div className="flex flex-col justify-end pb-5 w-full h-full md:pl-8">
      {/* Heading */}
      <h1 className="text-left text-xl md:text-4xl font-semibold mb-6 leading-tight">
      ...
      <a
        ...
        download
        className="px-6 py-3 text-white font-medium rounded hover:bg-[#3a372f] transition w-max bg-black"
      >
        Get CV
      </a>
    </div>
